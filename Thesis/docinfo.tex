...
Die Arbeit ermöglicht zunächst einen Einblick in den momentanen Stand der Technik, wie
bislang eine GUI für ein Non-Deeply Embedded System implementiert wurde. Weitergehend soll
veranschaulicht werden wie eine GUI mithilfe von .Net Core und Blazor implementiert werden könnte.
Am Ende dieser Arbeit wird ein aussagekräftiges Fazit darüber abgegeben, ob die
Technologie Blazor für die Frontend-Entwicklung im Non-Deeply Embedded Bereich geeignet ist.}
