...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth, center]{StandDerTechnik/ClientServerJS}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth, center]{StandDerTechnik/ClientServerCsharp}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth, center]{StandDerTechnik/ClientServerSignalR}
