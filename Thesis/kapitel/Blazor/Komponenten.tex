...
Unterschied zwischen den beiden ist, dass man eine Page-Komponente durch eine URL adressieren
...
\lstinputlisting[language={[Sharp]C},caption={Page-Komponente Beispiel},
    label=lst:counterpage]{\srcloc/StandDerTechnik/Counter.cs}
...
\lstinputlisting[language={[Sharp]C},caption={Kind Komponente},
    label=lst:childkomponente]{\srcloc/StandDerTechnik/Child.razor}

\lstinputlisting[language={[Sharp]C},caption={Eltern Komponente},
    label=lst:parentkomponente]{\srcloc/StandDerTechnik/Parent.razor}
...
mitgeben. Der Html Tag der Kind Komponente, wird du den Dateinamen der Komponente erzeugt, das
