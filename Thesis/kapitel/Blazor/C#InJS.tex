...
Nun kann es auch den Fall geben, dass C\# code von Javascript aufgerufen werden muss. Dies wird mit
...
\end{itemize}
bereitgestellt, mit denen dann eine statische C\#-Methode aufgerufen werden kann. Dabei geben
...
Javascript-Methode wird dann wiederum eine C\#-Methode aufgerufen. Das Ergebniss der C\#-Methode
